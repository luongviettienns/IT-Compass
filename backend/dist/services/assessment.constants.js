...
export const HOLLAND_GROUPS = ['R', 'I', 'A', 'S', 'E', 'C'];
export const HOLLAND_QUESTION_IDS = hollandQuestionsCatalog.map((question) => question.id);
export const SITUATIONAL_OPTION_IDS = Object.fromEntries(situationalQuestionsCatalog.map((question) => [
    question.id,
...
export const RESULT_CODE_BY_PAIR = {
    CI: 'SE',
    IR: 'Cybersecurity',
    AS: 'UXUI',
    AI: 'UXUI',
...
export const RESULT_AFFINITY_WEIGHTS = {
