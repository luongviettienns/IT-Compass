 ...
 */
export const hashPassword = async (plainTextPassword) => bcrypt.hash(plainTextPassword, SALT_ROUNDS);
/**
 ...
 */
export const verifyPassword = async (plainTextPassword, passwordHash) => bcrypt.compare(plainTextPassword, passwordHash);
