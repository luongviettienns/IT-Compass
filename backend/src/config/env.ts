...
/** Các môi trường hợp lệ của ứng dụng. */
export type NodeEnv = 'production' | 'staging' | 'development' | 'test';

/** Interface mô tả toàn bộ biến môi trường đã được parse và typed. */
