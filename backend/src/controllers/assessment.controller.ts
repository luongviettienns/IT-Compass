...
export const getCurrentTemplate = asyncHandler(async (_req: Request, res: Response) => {
...
export const submitAttempt = asyncHandler(async (req: Request, res: Response) => {
  ...
  const body = req.body as SubmitAssessmentAttemptBody;
...
export const getLatestAttempt = asyncHandler(async (req: Request, res: Response) => {
  const user = requireAuthenticatedUser(req);
...
export const getAttemptHistory = asyncHandler(async (req: Request, res: Response) => {
  const user = requireAuthenticatedUser(req);
  const query = req.query as unknown as AssessmentHistoryQuery;
...
export const getAttemptById = asyncHandler(async (req: Request, res: Response) => {
  const user = requireAuthenticatedUser(req);
  const params = req.params as AssessmentAttemptByIdParams;
...
export const getAdminAssessmentStats = asyncHandler(async (_req: Request, res: Response) => {
