...
const updateRouteMetric = ({ routeKey, durationMs, statusCode }: { routeKey: string; durationMs: number; statusCode: number }) => {
...
export const metricsMiddleware = (req: Request, res: Response, next: NextFunction) => {
  res.on('finish', () => {
    ...
    if (statusCode === 429) metricsState.totalRateLimited += 1;
