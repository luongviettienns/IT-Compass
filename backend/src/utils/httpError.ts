...
/** Chi tiết lỗi cho từng field (dùng cho validation errors). */
...
export class HttpError extends Error {
  ...
  constructor(statusCode: number, message: string, details?: unknown, code?: string) {
    ...
    this.code = code || DEFAULT_ERROR_CODES[statusCode as keyof typeof DEFAULT_ERROR_CODES] || 'REQUEST_FAILED';
  }
