...
import type { SerializedUser, SerializedUserProfile, UserWithOptionalProfile } from '../types/auth.js';
 ...
 */
const serializeUserProfile = (profile: NonNullable<UserWithOptionalProfile['profile']>): SerializedUserProfile => ({
 ...
 */
export const serializeUser = (user: UserWithOptionalProfile): SerializedUser => {
