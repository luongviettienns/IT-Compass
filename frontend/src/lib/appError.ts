...
const ERROR_MESSAGE_BY_CODE: Record<string, string> = {
  ...
  BOOKING_ID_REQUIRED: 'Thiếu mã lịch tư vấn.',
  BOOKING_INVALID_DATE_TIME: 'Ngày hoặc giờ tư vấn không hợp lệ.',
  BOOKING_ENDS_NEXT_DAY: 'Lịch tư vấn phải kết thúc trong cùng ngày đã chọn.',
  BOOKING_INVALID_DATE_FILTER: 'Bộ lọc ngày tư vấn không hợp lệ.',
  BOOKING_INVALID_DURATION_STEP: 'Thời lượng tư vấn phải theo bước 30 phút.',
  BOOKING_DURATION_OUT_OF_RANGE: 'Thời lượng tư vấn không nằm trong giới hạn mentor cho phép.',
  BOOKING_NOTICE_TOO_SHORT: 'Bạn cần đặt lịch sớm hơn theo thời gian báo trước của mentor.',
  BOOKING_TOO_FAR_IN_ADVANCE: 'Ngày tư vấn vượt quá khoảng thời gian đặt trước tối đa của mentor.',
  BOOKING_OUTSIDE_AVAILABILITY: 'Khung giờ đã chọn nằm ngoài lịch rảnh của mentor.',
  BOOKING_TIME_CONFLICT: 'Khung giờ này đã có lịch khác. Vui lòng chọn thời gian khác.',
  BOOKING_SETTING_INVALID_STEP: 'Cài đặt thời lượng phải theo bước 30 phút.',
  BOOKING_SETTING_INVALID_RANGE: 'Khoảng thời lượng tư vấn không hợp lệ.',
  BOOKING_SETTING_INVALID_DEFAULT: 'Thời lượng mặc định phải nằm trong khoảng tối thiểu và tối đa.',
  BOOKING_NOT_FOUND: 'Không tìm thấy lịch tư vấn.',
  BOOKING_SELF_NOT_ALLOWED: 'Bạn không thể đặt lịch với chính mình.',
  BOOKING_CANNOT_CANCEL: 'Lịch tư vấn này không thể hủy ở trạng thái hiện tại.',
  BOOKING_CANNOT_CONFIRM: 'Lịch tư vấn này không thể xác nhận ở trạng thái hiện tại.',
  BOOKING_CANNOT_COMPLETE: 'Lịch tư vấn này không thể đánh dấu hoàn thành ở trạng thái hiện tại.',
  BOOKING_NOT_ENDED: 'Chỉ có thể hoàn thành lịch tư vấn sau khi buổi tư vấn kết thúc.',
  CONVERSATION_BOOKING_NOT_CONFIRMED: 'Cuộc trò chuyện chỉ mở sau khi lịch tư vấn được xác nhận.',
  CONVERSATION_NOT_FOUND: 'Không tìm thấy cuộc trò chuyện của lịch tư vấn này.',
  CONVERSATION_FORBIDDEN: 'Bạn không có quyền truy cập cuộc trò chuyện này.',
